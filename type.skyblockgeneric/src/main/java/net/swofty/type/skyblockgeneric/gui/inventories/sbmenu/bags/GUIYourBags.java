...
public class GUIYourBags extends StatelessView {
    ...
    public void layout(ViewLayout<DefaultState> layout, DefaultState state, ViewContext ctx) {
        ...
        if (player.hasCustomCollectionAward(CustomCollectionAward.SACK_OF_SACKS)) {
            layout.slot(20, (s, c) -> TranslatableItemStackCreator.getStackHead("gui_sbmenu.bags.sack_of_sacks.unlocked",
            ...
            layout.slot(20, (s, c) -> TranslatableItemStackCreator.getStack("gui_sbmenu.bags.sack_of_sacks.locked", Material.GRAY_DYE, 1,
                    "gui_sbmenu.bags.sack_of_sacks.locked.lore"));
        }

        // Fishing Bag
        if (player.hasCustomCollectionAward(CustomCollectionAward.FISHING_BAG)) {
            layout.slot(21, (s, c) -> TranslatableItemStackCreator.getStackHead("gui_sbmenu.bags.fishing_bag.unlocked",
                    "eb8e297df6b8dffcf135dba84ec792d420ad8ecb458d144288572a84603b1631", 1,
                    "gui_sbmenu.bags.fishing_bag.unlocked.lore"));
        } else {
            layout.slot(21, (s, c) -> TranslatableItemStackCreator.getStack("gui_sbmenu.bags.fishing_bag.locked", Material.GRAY_DYE, 1,
                    "gui_sbmenu.bags.fishing_bag.locked.lore"));
        }

        // Potion Bag
        if (player.hasCustomCollectionAward(CustomCollectionAward.POTION_BAG)) {
            layout.slot(22, (s, c) -> TranslatableItemStackCreator.getStackHead("gui_sbmenu.bags.potion_bag.unlocked",
                    "9f8b82427b260d0a61e6483fc3b2c35a585851e08a9a9df372548b4168cc817c", 1,
                    "gui_sbmenu.bags.potion_bag.unlocked.lore"));
        } else {
            layout.slot(22, (s, c) -> TranslatableItemStackCreator.getStack("gui_sbmenu.bags.potion_bag.locked", Material.GRAY_DYE, 1,
                    "gui_sbmenu.bags.potion_bag.locked.lore"));
        }

        // Quiver
        if (player.hasCustomCollectionAward(CustomCollectionAward.QUIVER)) {
            layout.slot(23, (s, c) -> TranslatableItemStackCreator.getStackHead("gui_sbmenu.bags.quiver.unlocked",
            ...
            layout.slot(23, (s, c) -> TranslatableItemStackCreator.getStack("gui_sbmenu.bags.quiver.locked", Material.GRAY_DYE, 1,
