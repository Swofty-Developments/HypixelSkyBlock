...
public class GUIChocolateFactoryMilestones extends HypixelInventoryGUI {
    // Slot mapping for milestones (milestone number -> slot)
    // Layout based on the original design
    ...
    public GUIChocolateFactoryMilestones() {
        super("Chocolate Factory Milestones", InventoryType.CHEST_6_ROW);
    }
    ...
    public void setItems(InventoryGUIOpenEvent e) {
        ...
        for (ChocolateMilestone milestone : ChocolateMilestone.values()) {
            ...
            set(createMilestoneItem(slot, milestone, allTimeChocolate));
        }
    ...
    private GUIItem createMilestoneItem(int slot, ChocolateMilestone milestone, long allTimeChocolate) {
        boolean unlocked = milestone.isUnlocked(allTimeChocolate);
        ...
        if (unlocked) {
            ...
            return new GUIItem(slot) {
                ...
                public ItemStack.Builder getItem(HypixelPlayer p) {
                    ...
                    DatapointChocolateFactory.ChocolateFactoryData data = ChocolateFactoryHelper.getData(player);
                    return createLockedMilestoneItem(milestone, data.getChocolateAllTime());
                }
            };
        }
    }
