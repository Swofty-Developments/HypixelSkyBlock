...
public class MissionCompleteTheRaceTwoMinutes extends SkyBlockMission {

	@Override
	public String getID() {
		return "complete_the_race_two_minutes";
	}

	@Override
	public String getName() {
		return "Complete The Woods Race in 2m";
	}
	...
	public void onEnd(SkyBlockPlayer player, Map<String, Object> customData, MissionData.ActiveMission mission) {
		player.getMissionData().startMission(MissionTalkToGustaveAgain.class);
	}
