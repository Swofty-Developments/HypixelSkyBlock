package net.swofty.type.skyblockgeneric.minion.minions.foraging;
...
import net.swofty.type.skyblockgeneric.minion.actions.MinionCutTreeAction;
...
public class MinionSpruce extends SkyBlockMinion {
    ...
    public List<MinionExpectation> getExpectations() {
        return List.of(
                new BlockExpectation(-1, Block.SPRUCE_LOG, Block.AIR)
        );
    }

    @Override
    public MinionAction getAction() {
        return new MinionCutTreeAction(Block.SPRUCE_LOG);
    }
}
