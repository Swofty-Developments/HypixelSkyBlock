...
public class GUIBestiary extends HypixelInventoryGUI {
    ...
    private enum BestiaryRegions {
        ...
        DEEP_CAVERNS("§bDeep Caverns", new GUIMaterial("569a1f114151b4521373f34bc14c2963a5011cdc25a6554c48c708cd96ebfc"), new GUIBestiaryIsland(BestiaryCategories.DEEP_CAVERNS), "§7View all of the mobs that you've", "§7found and killed in the §bDeep Caverns§7."),
