...
public class JungleIslandConfiguration extends SkyBlockRegenConfiguration {
    @Override
    ...
    public List<Material> getMineableBlocks(Instance instance, Point point) {
        return List.of(Material.JUNGLE_LOG, Material.JUNGLE_LEAVES, Material.JUNGLE_WOOD);
    }
