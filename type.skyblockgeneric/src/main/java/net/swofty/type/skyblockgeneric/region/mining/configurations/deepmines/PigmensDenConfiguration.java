...
public class PigmensDenConfiguration extends SkyBlockMiningConfiguration {
    ...
    public MiningTask handleStageOne(MiningTask task, Pos brokenBlock) {
        ...
        regenerationBlock = getRandomBlock(
                new RegenerationConfig(30, Block.REDSTONE_ORE),
    ...
    public List<Material> getMineableBlocks(Instance instance, Point point) {
        return List.of(Material.REDSTONE_ORE, Material.COBBLESTONE, Material.STONE);
    }
