...
public class SlimehillConfiguration extends SkyBlockMiningConfiguration {
    ...
    public MiningTask handleStageOne(MiningTask task, Pos brokenBlock) {
        ...
        regenerationBlock = getRandomBlock(
                new RegenerationConfig(30, Block.EMERALD_ORE),
    ...
    public List<Material> getMineableBlocks(Instance instance, Point point) {
        return List.of(Material.EMERALD_ORE, Material.COBBLESTONE, Material.STONE);
    }
