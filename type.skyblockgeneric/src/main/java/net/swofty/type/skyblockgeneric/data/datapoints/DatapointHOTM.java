...
/**
 * Datapoint for storing Heart of the Mountain (HOTM) data.
 */
public class DatapointHOTM extends SkyBlockDatapoint<DatapointHOTM.PlayerHOTMData> {
    ...
    public static class PlayerHOTMData {
        ...
        public static PlayerHOTMData createDefault() {
            ...
            data.tokens = 1; // Start with 1 token at tier 1
            data.tokensSpent = 0;
            return data;
        }

        /**
         * Gets the current HOTM tier based on experience.
         * @return tier 1-10
         */
        public int getTier() {
        ...
        /**
         * Gets the cumulative XP required for the next tier.
         * @return XP needed for next tier, or -1 if maxed
         */
        ...
        /**
         * Checks if HOTM is maxed (tier 10).
         * @return true if tier 10 reached
         */
        ...
        /**
         * Adds HOTM experience and handles level ups.
        ...
        public int addExperience(long amount) {
            ...
            if (levelUps > 0) {
                // Award tokens for each tier gained
        ...
        /**
         * Gets the number of available (unspent) tokens.
        ...
        /**
         * Spends a token on a perk.
         * @return true if token was spent, false if not enough tokens
         */
        ...
        /**
         * Gets progress to next tier as a percentage (0-100).
