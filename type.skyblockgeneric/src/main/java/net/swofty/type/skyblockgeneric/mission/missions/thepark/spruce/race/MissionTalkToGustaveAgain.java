...
public class MissionTalkToGustaveAgain extends SkyBlockMission implements LocationAssociatedMission {
	...
	public void onEnd(SkyBlockPlayer player, Map<String, Object> customData, MissionData.ActiveMission mission) {
		player.getMissionData().startMission(MissionCompleteTheRaceOneMinute.class);
	}
