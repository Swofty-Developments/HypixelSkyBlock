package net.swofty.commons.skyblock.server.attribute;
...
import net.swofty.commons.skyblock.data.mongodb.AttributeDatabase;
import net.swofty.commons.skyblock.server.attribute.attributes.AttributeLong;
...
public class SkyBlockServerAttributes {
    ...
    public static Document toDocument() {
        ...
        serverAttributes.forEach((key, attribute) -> {
            attribute.setValue(key.onSave.apply(new SkyBlock()).getValue());
    ...
    public enum Attributes {
        ...
        public final Function<SkyBlock, ServerAttribute> onSave;

        Attributes(String key, Class<? extends ServerAttribute> type, ServerAttribute defaultAttribute, Consumer<ServerAttribute> onLoad, Function<SkyBlock, ServerAttribute> onSave) {
            this.key = key;
            this.type = type;
