package net.swofty.type.zombiesconfigurator.events;
...
public class ActionPlayerDataSpawn implements HypixelEventClass {
    ...
    public void run(PlayerSpawnEvent event) {
        ...
        player.sendMessage(Component.text("§6§l=== Zombies Configurator ==="));
        player.sendMessage(Component.text("§eUse §b/choosemap <mapId> §eto load a map"));
        player.sendMessage(Component.text("§eUse §b/zombiesconfig §eto configure the map"));
