...
@CommandParameters(aliases = "choose choosemap selectmap select",
        description = "Choose a Zombies map to configure",
        usage = "/choosemap <map>",
        permission = Rank.STAFF,
        allowsConsole = false)
public class ChooseMapCommand extends HypixelCommand {

    private static final Path CONFIG_PATH = Path.of("./configuration/zombies/");
    ...
    public void registerUsage(MinestomCommand command) {
        ...
        command.addSyntax((sender, context) -> {
            ...
            player.sendMessage(Component.text("§7Use §b/zombies §7to configure the map."));
