...
public class TypeZombiesConfiguratorLoader implements HypixelTypeLoader {
    ...
    public ServerType getType() {
        return ServerType.ZOMBIES_CONFIGURATOR;
    }
    ...
    public void onInitialize(MinecraftServer server) {
        ...
        MinecraftServer.getConnectionManager().setPlayerProvider((PlayerConnection playerConnection, GameProfile gameProfile) -> {
            ...
            Logger.info("Zombies Configurator: " + username + " joined");
    ...
    public void afterInitialize(MinecraftServer server) {
        HypixelGenericLoader.loopThroughPackage("net.swofty.type.zombiesconfigurator.commands", HypixelCommand.class).forEach(command -> {
            try {
        ...
        Logger.info("Zombies Configurator loaded. Use /zombies to start.");
    }
    ...
    public List<HypixelEventClass> getTraditionalEvents() {
        return HypixelGenericLoader.loopThroughPackage(
                "net.swofty.type.zombiesconfigurator.events",
