...
public class DataLockManager {
    ...
    private static final long LOCK_TIMEOUT = 30_000; // 30 seconds

    public record LockInfo(UUID lockId, long timestamp, String requesterId) {
    ...
    public static boolean acquireLock(String lockKey, String requesterId) {
        ...
        activeLocks.put(lockKey, new LockInfo(UUID.randomUUID(), System.currentTimeMillis(), requesterId));
        return true;
    }
