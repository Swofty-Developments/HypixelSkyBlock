package net.swofty.type.ravengaardgeneric.event.actions.player;
...
import net.swofty.type.ravengaardgeneric.texturepack.TexturePackManager;
...
public class ActionPlayerFirstSpawnTexturePack implements HypixelEventClass {
    ...
    public void run(PlayerSpawnEvent event) {
        ...
        if (HypixelConst.getResourcePackManager() == null) {
            Logger.warn("Resource pack manager is null during Ravengaard first spawn for {}", player.getUsername());
        }
