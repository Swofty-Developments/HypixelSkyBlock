...
public class ArmorShopItem extends ShopItem {
    ...
    public void onBought(Player player) {
        ...
        if (player.hasTag(Tag.Integer("upgrade_reinforced_armor"))) {
            ...
            TypeBedWarsGameLoader.getTeamShopService().getUpgrade("reinforced_armor").applyEffect(TypeBedWarsGameLoader.getGameById(gameId), team, player.getTag(Tag.Integer("upgrade_reinforced_armor")));
        }
    }
