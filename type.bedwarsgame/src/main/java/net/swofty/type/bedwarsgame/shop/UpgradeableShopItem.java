...
public abstract class UpgradeableShopItem extends ShopItem {
    ...
    public UpgradeableShopItem(String id, String name, String description, List<UpgradeableItemTier> tiers,
                               Tag<Integer> upgradeTag,
                               DatapointBedWarsHotbar.HotbarItemType hotbarItemType) {
        // The initial price and other details are taken from the first tier.
        super(id, name, description, tiers.getFirst().price(), 1, tiers.getFirst().currency(), tiers.getFirst().material(), hotbarItemType);
        this.tiers = tiers;
    ...
    public void onPurchase(BedWarsPlayer player) {
        ...
        giveItem(player, ItemStack.of(tier.material()));
