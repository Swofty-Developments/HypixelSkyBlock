...
public class DiamondLeggings implements CustomSkyBlockItem, StandardItem, DefaultCraftable {
    @Override
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.DIAMOND_LEGGINGS), ingredientMap, pattern);
    }
}