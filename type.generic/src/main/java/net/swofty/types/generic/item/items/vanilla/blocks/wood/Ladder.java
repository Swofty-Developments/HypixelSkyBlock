...
public class Ladder implements PlaceableCustomSkyBlockItem, DefaultCraftable, Sellable {
    @Override
    public SkyBlockRecipe<?> getRecipe() {
        ...
        List<String> pattern = List.of(
                ...
                "AAA",
                "A A");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.LADDER, 3), ingredientMap, pattern);
    }
