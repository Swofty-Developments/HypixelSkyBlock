...
import net.swofty.types.generic.block.placement.states.state.WallHeight;
...
import net.swofty.types.generic.block.placement.states.FenceGateState;
import net.swofty.types.generic.block.placement.states.WallState;
