...
public class WhiteCarpet implements PlaceableCustomSkyBlockItem, Sellable, DefaultCraftable {
    @Override
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        List<String> pattern = List.of(
                "AA");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.WHITE_CARPET, 3), ingredientMap, pattern);
    }
}
