...
public class CrystallizedHeart implements CustomSkyBlockItem, SkullHead, TrackedUniqueItem, StandardItem,
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        ingredientMap.put('A', new MaterialQuantifiable(ItemTypeLinker.ENCHANTED_DIAMOND, 32));
        ingredientMap.put('B', new MaterialQuantifiable(ItemTypeLinker.ZOMBIE_HEART, 1));
        List<String> pattern = List.of(
                "AAA",
                "ABA",
                "AAA");

        return new ShapedRecipe(SkyBlockRecipe.RecipeType.REVENANT_HORROR, new SkyBlockItem(ItemTypeLinker.CRYSTALLIZED_HEART), ingredientMap, pattern);
    }
