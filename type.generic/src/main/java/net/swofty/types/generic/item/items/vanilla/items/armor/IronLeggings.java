...
public class IronLeggings implements CustomSkyBlockItem, StandardItem, DefaultCraftable {
    @Override
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.IRON_LEGGINGS), ingredientMap, pattern);
    }
}
