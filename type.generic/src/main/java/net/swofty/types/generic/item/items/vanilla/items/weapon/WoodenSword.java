...
public class WoodenSword implements CustomSkyBlockItem, StandardItem, DefaultCraftable, Sellable {
    @Override
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.WOODEN_SWORD), ingredientMap, pattern);
    }
