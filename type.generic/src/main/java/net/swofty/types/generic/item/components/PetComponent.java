...
import net.swofty.types.generic.item.handlers.pet.PetAbility;
import net.swofty.types.generic.item.SkyBlockItemComponent;
import net.swofty.types.generic.item.handlers.pet.PetHandler;
import net.swofty.types.generic.item.handlers.pet.PetRegistry;
