...
public enum BazaarCategories {
    ...
    COMBAT(Material.IRON_SWORD, Material.RED_STAINED_GLASS_PANE,
            ...
            new BazaarItemSet(ItemType.SLIMEBALL, "Slime Drops",
                    ItemType.SLIMEBALL, ItemType.ENCHANTED_SLIMEBALL, ItemType.ENCHANTED_SLIME_BLOCK, ItemType.MAGMA_CREAM, ItemType.ENCHANTED_MAGMA_CREAM, ItemType.WHIPPED_MAGMA_CREAM),
