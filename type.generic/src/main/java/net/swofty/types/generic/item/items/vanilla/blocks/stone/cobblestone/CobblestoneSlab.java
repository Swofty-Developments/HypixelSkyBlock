...
public class CobblestoneSlab implements PlaceableCustomSkyBlockItem, DefaultCraftable, Sellable {
    @Override
    public SkyBlockRecipe<?> getRecipe() {
        ...
        List<String> pattern = List.of(
                "AAA");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.COBBLESTONE_SLAB, 6), ingredientMap, pattern);
    }
