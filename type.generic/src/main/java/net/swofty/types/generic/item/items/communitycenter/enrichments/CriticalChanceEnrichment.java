...
public class CriticalChanceEnrichment implements CustomSkyBlockItem, SkullHead, NotFinishedYet {
    @Override
    ...
    public String getSkullTexture(@Nullable SkyBlockPlayer player, SkyBlockItem item) {
        return "9e95293acbcd4f55faf5947bfc5135038b275a7ab81087341b9ec6e453e839";
    }
    ...
    public List<String> getLore(SkyBlockPlayer player, SkyBlockItem item) {
        return List.of(
                ...
                "§7power of §9+1☣ Crit Chance §7when",
