...
public class YellowStainedGlassPane implements PlaceableCustomSkyBlockItem, Sellable, MultiDefaultCraftable {
    ...
    public List<SkyBlockRecipe<?>> getRecipes() {
        ...
        ingredientMap1.put('A', new MaterialQuantifiable(ItemTypeLinker.YELLOW_STAINED_GLASS, 1));
        ...
        ingredientMap2.put('B', new MaterialQuantifiable(ItemTypeLinker.YELLOW_DYE, 1));
