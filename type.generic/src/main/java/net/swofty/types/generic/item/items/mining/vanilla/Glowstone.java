...
public class Glowstone implements PlaceableCustomSkyBlockItem, Sellable, DefaultCraftable {
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        ingredientMap.put('A', new MaterialQuantifiable(ItemTypeLinker.GLOWSTONE_DUST, 1));
        List<String> pattern = List.of(
                "AA",
                "AA");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.GLOWSTONE), ingredientMap, pattern);
    }
