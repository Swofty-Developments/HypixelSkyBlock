...
public class RedCarpet implements PlaceableCustomSkyBlockItem, Sellable, DefaultCraftable {
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        ingredientMap.put('A', new MaterialQuantifiable(ItemTypeLinker.RED_WOOL, 1));
        List<String> pattern = List.of(
                "AA");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.RED_CARPET, 3), ingredientMap, pattern);
    }
}
