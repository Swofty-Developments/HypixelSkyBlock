...
public class LapisLazuliBlock implements PlaceableCustomSkyBlockItem, Sellable, DefaultCraftable {
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        ingredientMap.put('A', new MaterialQuantifiable(ItemTypeLinker.LAPIS_LAZULI, 1));
        List<String> pattern = List.of(
                "AAA",
                "AAA",
                "AAA");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.LAPIS_LAZULI_BLOCK), ingredientMap, pattern);
    }
