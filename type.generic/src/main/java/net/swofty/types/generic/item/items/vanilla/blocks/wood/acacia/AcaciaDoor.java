...
public class AcaciaDoor implements PlaceableCustomSkyBlockItem, DefaultCraftable, Sellable {
    @Override
    public SkyBlockRecipe<?> getRecipe() {
        ...
        List<String> pattern = List.of(
                ...
                "AA",
                "AA");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.OAK_DOOR, 3), ingredientMap, pattern);
    }
