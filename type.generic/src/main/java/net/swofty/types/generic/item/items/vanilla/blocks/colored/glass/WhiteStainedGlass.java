...
public class WhiteStainedGlass implements PlaceableCustomSkyBlockItem, Sellable, DefaultCraftable {
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        ingredientMap.put('B', new MaterialQuantifiable(ItemTypeLinker.WHITE_DYE, 1));
        List<String> pattern = List.of(
                "AAA",
                "ABA",
                "AAA");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.WHITE_STAINED_GLASS, 8), ingredientMap, pattern);
    }
}
