...
public class SlimeBlock implements PlaceableCustomSkyBlockItem, Sellable, DefaultCraftable {
    @Override
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        ingredientMap.put('A', new ItemQuantifiable(ItemTypeLinker.SLIME_BALL, 1));
