...
public class ScarfsGrimoire implements TieredTalisman, NotFinishedYet, DefaultCraftable, SkullHead {
    @Override
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        ingredientMap.put('A', new ItemQuantifiable(ItemTypeLinker.SCARFS_THESIS, 1));
