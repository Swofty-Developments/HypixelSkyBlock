...
public class MediumMiningSack implements SkullHead, NotFinishedYet, Sack {
    ...
    public String getSkullTexture(@Nullable SkyBlockPlayer player, SkyBlockItem item) {
        return "100b1bf8554985f3decf54886922ad20d144438564ef7a5b52ced71bc9dd04bb";
    }
    ...
    public void onRightInteract(SkyBlockPlayer player, SkyBlockItem item) {
        new GUISack(ItemTypeLinker.MEDIUM_MINING_SACK, true).open(player);
    };
}
