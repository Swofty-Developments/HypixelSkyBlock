...
public class GUIBazaarOrderAmountSelection extends SkyBlockInventoryGUI  {
    ...
    private void addCustom(int slot, SkyBlockPlayer p) {
        set(new GUIQueryItem(slot) {
            @Override public SkyBlockInventoryGUI onQueryFinish(String q, SkyBlockPlayer pl) {
                try {
