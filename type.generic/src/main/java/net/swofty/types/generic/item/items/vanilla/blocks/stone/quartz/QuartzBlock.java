...
public class QuartzBlock implements PlaceableCustomSkyBlockItem, Sellable, DefaultCraftable {
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        ingredientMap.put('A', new MaterialQuantifiable(ItemTypeLinker.QUARTZ, 1));
        List<String> pattern = List.of(
                "AA",
                "AA");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemTypeLinker.QUARTZ_BLOCK), ingredientMap, pattern);
    }
