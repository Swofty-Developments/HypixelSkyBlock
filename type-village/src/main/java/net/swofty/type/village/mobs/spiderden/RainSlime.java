...
public class RainSlime extends SkyBlockMob implements RegionPopulator {

    public RainSlime(EntityType entityType) {
        super(entityType);
    }
    ...
    public ItemStatistics getBaseStatistics() {
        return ItemStatistics.builder()
                .with(ItemStatistic.HEALTH, 400D)
    ...
    public List<MobDrop> getDrops() {
        return new ArrayList<>(List.of(
                new MobDrop(20f, 1, 3, ItemType.SLIME_BALL)
        ));
    }
