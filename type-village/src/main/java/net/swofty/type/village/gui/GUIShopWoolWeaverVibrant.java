...
public class GUIShopWoolWeaverVibrant extends SkyBlockShopGUI {
    ...
    public void initializeShopItems() {
        ...
        /*
         * Second Page, not as it should be made lol
         */

        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.CYAN_TERRACOTTA), 1, new CoinShopPrice(8), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_BLUE_TERRACOTTA), 1, new CoinShopPrice(8), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLUE_TERRACOTTA), 1, new CoinShopPrice(8), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BROWN_TERRACOTTA), 1, new CoinShopPrice(8), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLACK_TERRACOTTA), 1, new CoinShopPrice(8), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.GRAY_TERRACOTTA), 1, new CoinShopPrice(8), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_GRAY_TERRACOTTA), 1, new CoinShopPrice(8), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.WHITE_TERRACOTTA), 1, new CoinShopPrice(8), 1));

        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.CYAN_STAINED_GLASS_PANE), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_BLUE_STAINED_GLASS_PANE), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLUE_STAINED_GLASS_PANE), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BROWN_STAINED_GLASS_PANE), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLACK_STAINED_GLASS_PANE), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.GRAY_STAINED_GLASS_PANE), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_GRAY_STAINED_GLASS_PANE), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.WHITE_STAINED_GLASS_PANE), 1, new CoinShopPrice(16), 1));

        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.CYAN_STAINED_GLASS), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_BLUE_STAINED_GLASS), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLUE_STAINED_GLASS), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BROWN_STAINED_GLASS), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLACK_STAINED_GLASS), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.GRAY_STAINED_GLASS), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_GRAY_STAINED_GLASS), 1, new CoinShopPrice(16), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.WHITE_STAINED_GLASS), 1, new CoinShopPrice(16), 1));

        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.CYAN_CARPET), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_BLUE_CARPET), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLUE_CARPET), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BROWN_CARPET), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLACK_CARPET), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.GRAY_CARPET), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_GRAY_CARPET), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.WHITE_CARPET), 1, new CoinShopPrice(32), 1));

        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.CYAN_WOOL), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_BLUE_WOOL), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLUE_WOOL), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BROWN_WOOL), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.BLACK_WOOL), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.GRAY_WOOL), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.LIGHT_GRAY_WOOL), 1, new CoinShopPrice(32), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.WHITE_WOOL), 1, new CoinShopPrice(32), 1));
    }
}
