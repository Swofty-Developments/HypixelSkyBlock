...
public class VoraciousSpider extends SkyBlockMob implements RegionPopulator {

    public VoraciousSpider(EntityType entityType) {
        super(entityType);
    }
    ...
    public ItemStatistics getBaseStatistics() {
        return ItemStatistics.builder()
                .with(ItemStatistic.HEALTH, 1000D)
