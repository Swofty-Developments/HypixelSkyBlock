...
public class GUIBitsSumsungAbicases extends SkyBlockInventoryGUI {
    ...
    private enum BitItems {
        SUMSUNG_G3_ABICASE(ItemType.SUMSUNG_G3_ABICASE, 15000),
        SUMSUNG_GG_ABICASE(ItemType.SUMSUNG_GG_ABICASE, 25000),
        ;
    ...
    public GUIBitsSumsungAbicases() {
        super("Bits Shop - Sumsung© Abicases", InventoryType.CHEST_5_ROW);
    }
