...
public class GUIShopLibrarian extends SkyBlockShopGUI {
    ...
    public void initializeShopItems() {
        attachItem(ShopItem.Stackable(new SkyBlockItem(Material.EXPERIENCE_BOTTLE), 1, new CoinShopPrice(30), 1));
        attachItem(ShopItem.Stackable(new SkyBlockItem(ItemType.BOOK), 1, new CoinShopPrice(20), 1));
        ...
        attachItem(ShopItem.Single(sharpness, 1, new CoinShopPrice(30), 1));
        attachItem(ShopItem.Single(scavenger, 1, new CoinShopPrice(40), 1));
        attachItem(ShopItem.Single(protection, 1, new CoinShopPrice(20), 1));
        attachItem(ShopItem.Single(efficiency, 1, new CoinShopPrice(20), 1));
