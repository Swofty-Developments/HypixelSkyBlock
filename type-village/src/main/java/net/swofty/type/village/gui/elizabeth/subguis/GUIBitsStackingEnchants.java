...
public class GUIBitsStackingEnchants extends SkyBlockInventoryGUI {
    ...
    private enum BitItems {
        EXPERTISE(ItemType.EXPERTISE, 4000),
        COMPACT(ItemType.COMPACT, 4000),
        CULTIVATING(ItemType.CULTIVATING, 4000),
        CHAMPION(ItemType.CHAMPION, 4000),
        HECATOMB(ItemType.HECATOMB, 6000),
        ;
    ...
    public GUIBitsStackingEnchants() {
        super("Bits Shop - Stacking Enchants", InventoryType.CHEST_5_ROW);
    }
