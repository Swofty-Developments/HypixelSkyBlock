...
public class GUIBitsRezarAbicase extends SkyBlockInventoryGUI {
    ...
    private enum BitItems {
        REZAR_ABICASE(ItemType.REZAR_ABICASE, 26000),
        ;
    ...
    public GUIBitsRezarAbicase() {
        super("Bits Shop - Rezar Abicase", InventoryType.CHEST_5_ROW);
    }
