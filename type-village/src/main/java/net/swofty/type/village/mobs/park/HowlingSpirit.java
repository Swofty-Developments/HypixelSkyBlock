...
public class HowlingSpirit extends SkyBlockMob implements RegionPopulator {

    public HowlingSpirit(EntityType entityType) {
        super(entityType);
    }
    ...
    public ItemStatistics getBaseStatistics() {
        return ItemStatistics.builder()
                .with(ItemStatistic.HEALTH, 7000D)
                .with(ItemStatistic.DAMAGE, 400D)
                .build();
    }
