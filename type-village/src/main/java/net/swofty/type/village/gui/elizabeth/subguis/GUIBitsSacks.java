...
public class GUIBitsSacks extends SkyBlockInventoryGUI {
    ...
    private enum BitItems {
        POCKET_SACK_IN_A_SACK(ItemType.POCKET_SACK_IN_A_SACK, 8000),
        DUNGEON_SACK(ItemType.DUNGEON_SACK, 14000),
        RUNE_SACK(ItemType.RUNE_SACK, 14000),
        FLOWER_SACK(ItemType.FLOWER_SACK, 14000),
        DWARVEN_SACK(ItemType.DWARVEN_SACK, 14000),
        CRYSTAL_HOLLOWS_SACK(ItemType.CRYSTAL_HOLLOWS_SACK, 14000),
        ;
    ...
    public GUIBitsSacks() {
        super("Bits Shop - Sacks", InventoryType.CHEST_5_ROW);
    }
