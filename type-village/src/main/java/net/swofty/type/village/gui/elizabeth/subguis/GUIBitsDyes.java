...
public class GUIBitsDyes extends SkyBlockInventoryGUI {
    ...
    private enum BitItems {
        PURE_WHITE_DYE(ItemType.PURE_WHITE_DYE, 250000),
        PURE_BLACK_DYE(ItemType.PURE_BLACK_DYE, 250000),
        ;
    ...
    public GUIBitsDyes() {
        super("Bits Shop - Dyes", InventoryType.CHEST_5_ROW);
    }
