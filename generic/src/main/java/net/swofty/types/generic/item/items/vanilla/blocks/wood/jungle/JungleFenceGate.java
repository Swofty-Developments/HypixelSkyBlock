...
public class JungleFenceGate implements PlaceableCustomSkyBlockItem, DefaultCraftable, Sellable {
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        ingredientMap.put('B', new MaterialQuantifiable(ItemType.JUNGLE_PLANKS, 1));
        List<String> pattern = List.of(
                "ABA",
                "ABA");
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemType.JUNGLE_FENCE_GATE), ingredientMap, pattern);
    }
