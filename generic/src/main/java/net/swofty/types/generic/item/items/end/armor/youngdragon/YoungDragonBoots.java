...
public class YoungDragonBoots implements CustomSkyBlockItem, StandardItem, DefaultCraftable, LeatherColour, Sellable {
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.COMBAT, new SkyBlockItem(ItemType.YOUNG_DRAGON_BOOTS), ingredientMap, pattern);
    }
