...
public class SpiderEggMixin implements CustomSkyBlockItem, DecorationHead, ExtraUnderNameDisplay, CustomDisplayName, NotFinishedYet {
    ...
    public ArrayList<String> getLore(SkyBlockPlayer player, SkyBlockItem item) {
        return new ArrayList<>(Arrays.asList(
                ...
                "§7stand and lasts for the full duration.", "", "§7Gain §a5%§7 dodge chance!",
                "", "§7Duration: §a36h", "+§a36h§7 Default", "", "§7The duration of Mixins can be stacked!",
                "§eRight-click to consume!", "§8(Requires active Booster Cookie)", "", "§c☠§7 Requires §dSpider Slayer 8§7."
        ));
    }
