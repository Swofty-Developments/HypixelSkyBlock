package net.swofty.types.generic.scoreboard;
 ...
 */
public class SwoftySidebar implements Scoreboard {
     ...
     * @deprecated Use {@link #SwoftySidebar(Component)}
     */
    @Deprecated
    public SwoftySidebar(@NotNull String title) {
     ...
     * @param title The title of the sidebar
     */
    public SwoftySidebar(@NotNull Component title) {
        this.title = title;
    ...
    /**
     * Changes the {@link SwoftySidebar} title
     *
