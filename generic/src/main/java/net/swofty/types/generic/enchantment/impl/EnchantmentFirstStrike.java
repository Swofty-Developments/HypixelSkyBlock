...
public class EnchantmentFirstStrike implements Ench, EnchFromTable {

    public static final double[] multipliers = new double[]{1.1, 1.15, 1.2, 1.25, 1.3, 1.35, 1.4};

    @Override
    public String getDescription(int level) {
        return "Increases melee damage dealt to targets without combat damage by §a" + ((multipliers[level - 1] - 1) * 100) + "%§7.";
    }
