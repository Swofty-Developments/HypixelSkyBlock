...
public class GrayStainedGlassPane implements PlaceableCustomSkyBlockItem, Sellable, MultiDefaultCraftable {
    ...
    public List<SkyBlockRecipe<?>> getRecipes() {
        ...
        ingredientMap1.put('A', new MaterialQuantifiable(ItemType.GRAY_STAINED_GLASS, 1));
        List<String> pattern1 = List.of(
                "AAA",
                "AAA");
        recipes.add(new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemType.GRAY_STAINED_GLASS_PANE, 16), ingredientMap1, pattern1));
        ...
        ingredientMap2.put('B', new MaterialQuantifiable(ItemType.GRAY_DYE, 1));
        List<String> pattern2 = List.of(
                "AAA",
                "ABA",
                "AAA");
        recipes.add(new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemType.GRAY_STAINED_GLASS_PANE, 8), ingredientMap2, pattern2));
        return recipes;
    }
