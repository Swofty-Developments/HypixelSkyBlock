...
public class GoldenShovel implements CustomSkyBlockItem, ShovelImpl, Craftable, Sellable {
    @Override
    ...
    public SkyBlockRecipe<?> getRecipe() {
        ...
        return new ShapedRecipe(SkyBlockRecipe.RecipeType.NONE, new SkyBlockItem(ItemType.GOLDEN_SHOVEL), ingredientMap, pattern);
    }
