...
public class GUIShopAdventurer extends SkyBlockShopGUI {
    ...
    public void initializeShopItems() {
        ...
        attachItem(ShopItem.Single(new SkyBlockItem(ItemTypeLinker.ZOMBIE_TALISMAN), 1, new CoinShopPrice(500)));
        attachItem(ShopItem.Single(new SkyBlockItem(ItemTypeLinker.SKELETON_TALISMAN), 1, new CoinShopPrice(500)));
        attachItem(ShopItem.Single(new SkyBlockItem(ItemTypeLinker.VILLAGE_AFFINITY_TALISMAN), 1, new CoinShopPrice(2500)));
        attachItem(ShopItem.Single(new SkyBlockItem(ItemTypeLinker.MINE_AFFINITY_TALISMAN), 1, new CoinShopPrice(2500)));
    }
}