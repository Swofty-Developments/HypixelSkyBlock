...
public class GUIShopBea extends SkyBlockShopGUI {
    ...
    public void initializeShopItems() {
        attachBeePet(Rarity.COMMON, new CombinedShopPrice(List.of(
                ...
                new ItemShopPrice(ItemTypeLinker.COAL_BLOCK, 2),
                new ItemShopPrice(ItemTypeLinker.GOLD_BLOCK, 2)
        )));
        attachBeePet(Rarity.RARE, new CombinedShopPrice(List.of(
                new CoinShopPrice(50000),
                new ItemShopPrice(ItemTypeLinker.COAL_BLOCK, 128),
                new ItemShopPrice(ItemTypeLinker.GOLD_BLOCK, 128)
        )));
        attachBeePet(Rarity.EPIC, new CombinedShopPrice(List.of(
                new CoinShopPrice(200000),
                new ItemShopPrice(ItemTypeLinker.ENCHANTED_COAL_BLOCK, 1),
                new ItemShopPrice(ItemTypeLinker.ENCHANTED_GOLD_BLOCK, 1)
        )));
        attachBeePet(Rarity.LEGENDARY, new CombinedShopPrice(List.of(
                new CoinShopPrice(650000),
                new ItemShopPrice(ItemTypeLinker.ENCHANTED_COAL_BLOCK, 8),
                new ItemShopPrice(ItemTypeLinker.ENCHANTED_GOLD_BLOCK, 8)
        )));
    }

    public void attachBeePet(Rarity rarity, CombinedShopPrice price) {
        SkyBlockItem beeItem = new SkyBlockItem(ItemTypeLinker.BEE_PET);
        beeItem.getAttributeHandler().setRarity(rarity);
        ShopItem bee = ShopItem.Single(beeItem,
                1,
                price);

        SkyBlockItem beeDisplayItem = new SkyBlockItem(ItemTypeLinker.BEE_PET);
