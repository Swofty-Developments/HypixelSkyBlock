...
public class GUIShopFarmMerchant extends SkyBlockShopGUI {
    ...
    public void initializeShopItems() {
        ...
        attachItem(ShopItem.Stackable(new SkyBlockItem(ItemTypeLinker.ENCHANTED_BONE_MEAL), 3, new CoinShopPrice(6)));
        attachItem(ShopItem.Single(new SkyBlockItem(ItemTypeLinker.ROOKIE_HOE), 1, new CoinShopPrice(10)));
