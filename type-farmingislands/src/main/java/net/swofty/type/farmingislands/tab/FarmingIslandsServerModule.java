package net.swofty.type.farmingislands.tab;
...
public class FarmingIslandsServerModule extends TablistModule {
    @Override
    public List<TablistEntry> getEntries(SkyBlockPlayer player) {
        ...
        entries.add(new TablistEntry("§b§lArea: §7Farming Islands", TablistSkinRegistry.GRAY));
