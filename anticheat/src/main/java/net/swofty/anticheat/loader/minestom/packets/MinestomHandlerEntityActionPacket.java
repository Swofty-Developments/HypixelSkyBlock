...
public class MinestomHandlerEntityActionPacket
    ...
    public SwoftyPacket buildSwoftyPacket(UUID uuid, ClientEntityActionPacket packet) {
        ...
        int jumpBoost = packet.horseJumpBoost();
    ...
    private EntityActionPacket.Action mapAction(ClientEntityActionPacket.Action minestomAction) {
        return switch (minestomAction) {
