...
public class GetServerForMapEndpoint implements ServiceEndpoint
    ...
    private GetServerForMapProtocolObject.GetServerForMapResponse instantiateBedwarsGame(BedWarsGameType gameType, String map) {
        ...
        instantiateMessage.put("map", map);
        ...
        try {
            ...
            if (response != null && response.optBoolean("success", false)) {
                String gameId = response.optString("gameId", response.optString("game", null));
                if (gameId != null) {
                    return new GetServerForMapProtocolObject.GetServerForMapResponse(createProxy(availableServer), gameId);
                }
            }
        } catch (Exception e) {
