package net.swofty.type.ravengaardlobby;
...
public class TypeRavengaardLobbyLoader implements RavengaardTypeLoader {

    @Override
    public ServerType getType() {
        return ServerType.RAVENGAARD_LOBBY;
    }

    @Override
    public void onInitialize(MinecraftServer server) {
        RegistryKey<DimensionType> fullbrightDimension = MinecraftServer.getDimensionTypeRegistry().register(
                Key.key("ravengaard:lobby_fullbright"),
        ...
        Logger.info("TypeRavengaardLobbyLoader initialized with preloaded minimap terrain");
    }
    ...
    public List<HypixelEventClass> getTraditionalEvents() {
        return RavengaardGenericLoader.loopThroughPackage(
                "net.swofty.type.ravengaardlobby.events",
