...
export const categories = [
  {name: "Ranks", slug: "ranks", icon: `${HYPIXEL_ASSETS}/icons/ranks/mvp-plus.png`, sale: true},
  ...
  {name: "Housing+", slug: "housing-plus", icon: `${HYPIXEL_ASSETS}/icons/housing-plus/icon.png`, sale: true},
  {name: "Boosters", slug: "boosters", icon: `${HYPIXEL_ASSETS}/icons/boosters/uhc.png`, sale: true},
  {name: "Companions", slug: "companions", icon: `${HYPIXEL_ASSETS}/icons/companions/icon.png`, sale: true},
];
